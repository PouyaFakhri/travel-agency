    ...
    <>
      ...
      {isLogin ? (
        <div className="relative">
          <button
            className="flex items-center gap-1 rounded-lg sm:px-1.5 sm:py-1 font-VazirFd font-medium sm:text-[15px] md:text-lg text-[#28A745] hover:bg-[#28A745]/10 transition-all duration-200 cursor-pointer"
            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
          >
            <Person className="w-[14px] h-[14px] sm:w-5 sm:h-5 md:w-6 md:h-6 fill-[#28A745]" />
            <span className="font-VazirFd font-medium text-sm sm:text-base md:text-lg text-[#28A745]">
          ...
          {isDropdownOpen && (
            <div className="absolute top-[150%] left-1/2 transform -translate-x-1/2 w-[120%] bg-white border border-gray-200 rounded-lg shadow-lg z-50 text-sm font-YekanBakh">
        ...
        <>
          ...
          />
          <div
            className="hidden sm:flex items-center border-2 border-[#28A745] rounded-lg sm:px-1 md:px-1.5 xl:px-2 sm:py-1 md:py-1.5 font-VazirFd font-medium sm:text-[15px] md:text-lg text-[#28A745] hover:bg-[#28A745]/10 transition-all duration-200 cursor-pointer"
            onClick={() => setIsAuthModalOn(true)}
          >
