  ...
  return (
    <>
      ...
      <div className={`flex ${isLogin ? "gap-0" : "gap-1"}`}>
        ...
        <div className={`flex items-center justify-center ${isLogin ? "border-none min-w-[30px] min-h-[40px]" : "border-[1.5px] sm:border-[1.6px] border-[#28A745] rounded-[8px] min-w-[40px] min-h-[40px] " }  cursor-pointer hover:bg-[#28A745]/10 transition-all duration-200`}>
          <Basket className="w-6 h-6 stroke-[#28A745]" />
        </div>
      </div>
      {isMobileNavOpen && (
        <>
