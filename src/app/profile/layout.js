            ...
            return (
              <li key={href}>
                <Link
                  ...
                  ${
                    isActive
                      ? "text-[#28A745] border-b-1 border-b-[#28A745]"
                      : "text-[#282828] hover:text-[#28A745] border-none"
                  }
                  font-YekanBakh
                  sm:border sm:rounded-lg sm:px-3 sm:py-2
                  ${
                    isActive
                      ? "sm:border-[#28A745] sm:bg-[#E9F7EF]"
                      : "sm:border-gray-300 sm:hover:border-[#28A745]"
                  }
                `}
                >
                  <Icon
