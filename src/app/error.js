  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      {isServerError ? (
        ...
        <div className="flex flex-col gap-5 items-center justify-center text-center bg-gradient-to-br from-white via-gray-50 to-gray-100 border border-gray-200 rounded-3xl p-5 xs:p-6 sm:p-7 md:p-9 lg:p-10 shadow-xl animate-fadeIn font-YekanBakh">
